...
public class PessoaDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4736503591315732689L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PessoaDTO\",\"namespace\":\"io.github.yesminmarie.kafkaschemaregistryexample.entity\",\"fields\":[{\"name\":\"nome\",\"type\":\"string\"},{\"name\":\"sobrenome\",\"type\":\"string\"}]}");
   ...
   */
  public static io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder newBuilder() {
    return new io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder();
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder newBuilder(io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder other) {
    return new io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder(other);
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder newBuilder(io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO other) {
    return new io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PessoaDTO>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.nome)) {
        this.nome = data().deepCopy(fields()[0].schema(), other.nome);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder setNome(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder clearNome() {
      nome = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder setSobrenome(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.yesminmarie.kafkaschemaregistryexample.entity.PessoaDTO.Builder clearSobrenome() {
      sobrenome = null;
